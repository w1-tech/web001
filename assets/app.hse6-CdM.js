import {R as i} from "./chunks/theme.BtTKPN_X.js";
import {R as o, a2 as u, a3 as c, a4 as l, a5 as f, a6 as d, a7 as m, a8 as h, a9 as g, aa as A, ab as v, d as P, u as R, v as w, s as y, ac as C, ad as b, ae as E, a0 as S} from "./chunks/framework.BE3BSss6.js";
function p(e) {
    if (e.extends) {
        const a = p(e.extends);
        return {
...
o && D().then( ({app: e, router: a, data: t}) => {
    a.go().then( () => {
        u(a.route, t.site),
        e.mount("#app")
    }
